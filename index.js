...
const getPageData = () => {
  return {
    ...
    "東京都_☆☆☆☆☆": [cast?.asami, cast?.furansowa, cast?.hinano_yuna, cast?.koyuki, cast?.minami_shiori, cast?.meari, cast?.rumina, cast?.thuru, cast?.yuutuki_kokona, cast?.kobayashi_ruru].filter(Boolean), 
    "東京都_☆☆☆☆": [cast?.rukachi, cast?.rukachi_2, cast?.rukachi_3, cast?.thukino_aina].filter(Boolean),
